...
def get_scatter_plot(entered_site, payload_value):
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df[filtered_df['Payload Mass (kg)'].between(payload_value[0], payload_value[1], inclusive=True)]
        fig = px.scatter(filtered_df,
        x='Payload Mass (kg)',
        y='class',
        color='Booster Version Category',
        title='Payload Mass (Kg) vs Mission Outcome for All Sites')
        return fig
    else:
        ...
        y='class',
        color='Booster Version Category',
        title=f'Payload Mass (kg) vs Mission Outcome for Site {entered_site}')
        return fig
